        ...
        <div class="mx-auto flex w-max min-w-max gap-3">
          ${this.entries.map((entry) => {
            ...
            return html`<button
              ...
              class="flex min-h-24 min-w-36 flex-col items-center justify-center gap-1 rounded-xl border p-3 text-center transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-950 ${isActive
