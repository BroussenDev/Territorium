  ...
  const input = html`
    <div class="relative w-full sm:flex-1 sm:min-w-0">
      <input
        ...
        .value=${value}
        @input=${onInput}
        class="w-full h-10 pl-10 pr-4 bg-white/5 border border-white/10 rounded-xl text-white placeholder-white/20 focus:outline-none focus:ring-2 focus:ring-brand/50 focus:border-brand/50 transition-all font-medium hover:bg-white/10 text-sm"
  ...
  return html`
    <div class="flex items-center gap-2 shrink-0">
      ...
      <button
        ...
        class="h-10 w-10 shrink-0 flex items-center justify-center bg-white/5 border border-white/10 rounded-xl text-white/70 hover:text-white hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-brand/50 focus:border-brand/50 transition-all"
      >
    ...
    <div class="flex items-center gap-2">
      ...
      >
        <div class="absolute inset-0 flex">
          ${wins > 0
            ? html`<div class="bg-brand h-full" style="width:${winPct}%"></div>`
            : ""}
          ${losses > 0
            ? html`<div
  ...
  return html`
    <div
      class="flex flex-col py-2.5 px-3 rounded-xl border
        ${isMe ? "bg-brand/10 border-brand/20" : "bg-white/5 border-white/10"}"
    >
