...
export class OButton extends LitElement {
  ...
  private variantClasses(): string {
    switch (this.variant) {
      case "primary":
        return "bg-brand hover:bg-brand-light text-white disabled:bg-gray-600 disabled:text-gray-300";
      case "secondary":
      ...
      case "ghost":
        return "bg-transparent hover:bg-white/10 text-brand disabled:text-gray-500 disabled:hover:bg-transparent";
    }
  }
